...
import { registerGetBrand } from "./get-brand.js";
import { registerGetBrandShippingPriceLists } from "./get-brand-shipping-price-lists.js";
...
export function registerPublicTools(server: McpServer, deps: ToolDeps): void {
  ...
  registerGetBrand(server, deps);
  registerGetBrandShippingPriceLists(server, deps);
